<template>
  <main id="main" class="main">
    ...
    <div v-else class="tableros-container">
      <div class="header">
        <h1><i class="fas fa-chart-line"></i> Tableros Power BI</h1>
      ...
      <!-- Modal para visualizar el tablero -->
      <div v-if="selectedTablero" class="modal-overlay" @click="closeModal">
